...
<?php
    $sql = $con -> prepare("SELECT * FROM animales, dueño, especies WHERE animales.documento = dueño.documento AND especies.id_especie = animales.id_especie ORDER BY animales.nombre ASC");
    $sql -> execute();
?>
...
<nav class="navbar navbar-expand-md">
    ...
    <div class=" d-flex justify-content-center align-items-center ">
        <div class="main-container rounded-5 text-secondary" style="width: 70rem">
            ...
            <h2 class="text-center text-dark fs-1 fw-bold" style="margin-right: 25%;">Listado de Mascotas</h2>
            <br>
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form action="agregar_usu.php">
                            <button type="submit" class="btn btn-dark m-1 shadow-sm">CREAR dueño</button>
                    </form>
                </div>
            </div>
            <br><br><br>
            ...
            <table style="border:#000 solid 1px">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['id_animal']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['nombre']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['genero']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['edad']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['raza']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['especie']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['nombres']?></td>
                            ...
                            <td style="background-color: #DCD6D6; border:#000 solid 2px;">
                                <form action= "./eliminar_usu.php" method="get">
                                    ...
                                    <button type="submit" class="btn btn-dark text-white w-70 mt-4 fw-semibold shadow-sm" onclick="return confirm ('¿Desea eliminar este dueño?');">Eliminar</button>
                                </form>
                            </td>
                        </tr>   
