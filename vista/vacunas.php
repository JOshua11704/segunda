...
<?php
    $sql = $con -> prepare("SELECT * FROM vacunas ORDER BY vacunas.vacuna ASC");
    $sql -> execute();
...
<nav class="navbar navbar-expand-md">
    ...
    <div class=" d-flex justify-content-center align-items-center ">
        <div class="main-container rounded-5 text-secondary" style="width: 85rem">
            ...
            <h2 class="text-center text-dark fs-1 fw-bold" style="margin-right: 25%;">Listado de vacuna</h2>
            <br>
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form action="./agregar_vacuna.php">
            ...
            <table style="border:#000 solid 1px">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['id_vacuna']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['vacuna']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['descript']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['periodo']?></td>
                         

                            
                            <td style="background-color: #DCD6D6; border:#000 solid 2px;">
                                <form action= "./eliminar_vacuna.php" method="get">
                                    <input type="hidden" name="eliminar" value= "<?=$sq['id_vacuna']?>">
                                    <button type="submit" class="btn btn-dark text-white w-70 mt-4 fw-semibold shadow-sm" onclick="return confirm ('¿Desea eliminar esta vacuna?');">Eliminar</button>
                                </form>
                            </td>
