...
<?php
    $sql = $con -> prepare("SELECT * FROM vacunador ORDER BY vacunador.nombre ASC");
    $sql -> execute();
    // $fila= $sql-> fetch(PDO::FETCH_ASSOC);
    
    
    // $edad_ntot= $fila['edad'];
    // $edad_num = 2023 - $edad_ntot;
?>
...
<nav class="navbar navbar-expand-md">
        <div class="barra_nav container-fluid navbar-nav">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" role="button">Mascotas y Vacunas</a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="./mascotas.php">Mascotas y Dueños</a></li>
                        <li><a class="dropdown-item" href="./vaccinators.php">Vacunas</a></li>
                    </ul>
                </li>
    
                    <li class="nav-item p-5">
                        <a class="nav-link" href="./index.php">Vacunadores y Vacunas</a>
                    </li>
    ...
    <div class=" d-flex justify-content-center align-items-center ">
        <div class="main-container rounded-5 text-secondary" style="width: 85rem">
            ...
            <h2 class="text-center text-dark fs-1 fw-bold" style="margin-right: 25%;">Listado</h2>
            <br>
            <div class="row">
                <div class="col-lg-6">
            ...
            <table style="border:#000 solid 1px">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['id_vacunador']?></td>
                            ...
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['tipo_vacuna']?></td>
                            ...
                            <td style="background-color: #DCD6D6; border:#000 solid 2px;">
                                <form action= "./eliminar_propie.php" method="get">
