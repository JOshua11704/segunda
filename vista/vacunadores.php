...
<?php
    $sql = $con -> prepare("SELECT * FROM vacunadores ORDER BY vacunadores.vacunador ASC");
    $sql -> execute();
...
<nav class="navbar navbar-expand-md">
    ...
    <div class=" d-flex justify-content-center align-items-center ">
        <div class="main-container rounded-5 text-secondary" style="width: 85rem">
            ...
            <h2 class="text-center text-dark fs-1 fw-bold" style="margin-right: 25%;">Listado de Vacunadores</h2>
            <br>
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form action="./agregar_vacunador.php">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['especialidad']?></td>
                         

                            <td style="background-color: #DCD6D6; border:#000 solid 2px;">
                                <form action= "./edit_vacunador.php" method="get">
                                    <input type="hidden" name="update" value= "<?=$sq['id_vacunador']?>">
                                    <button type= "submit" class="btn btn-dark text-white w-70 mt-4 fw-semibold shadow-sm">Editar</button>
                                </form>

                            </td>
                            <td style="background-color: #DCD6D6; border:#000 solid 2px;">
                                <form action= "./eliminar_vacunador.php" method="get">
                                    <input type="hidden" name="eliminar" value= "<?=$sq['id_vacunador']?>">
