...
<?php
    $sql = $con -> prepare("SELECT * FROM dueño ORDER BY dueño.nombres ASC");
    $sql -> execute();
...
<nav class="navbar navbar-expand-md">
    ...
    <div class=" d-flex justify-content-center align-items-center ">
        <div class="main-container rounded-5 text-secondary" style="width: 85rem">
            ...
            <h2 class="text-center text-dark fs-1 fw-bold" style="margin-right: 25%;">Listado de Dueños</h2>
            <br>
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <form action="./agregar_propie.php">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['apellidos']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['genero']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['email']?></td>
                            <td class="text-dark text-center" style="background-color: #DCD6D6;"><?=$sq['telefono']?></td>
